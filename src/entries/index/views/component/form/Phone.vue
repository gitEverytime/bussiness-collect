    ...
    <div>
        ...
        >
            <div
                    class="van-field-box"
                    :style="{
                        'borderBottom':page.common_data.text_color ? page.common_data.text_color + ' solid 1px' : 'none'
                    }"
            >
                ...
                <van-field
                    ...
                    :rules="[{validator: validator, message: form.regularprompt + '格式不正确' }]"
                    class="input-box"
                />
            </div>
            <!--            描述-->
		...
		mounted() {
            ...
            vm.$nextTick(() => {
                if(vm.page.common_data.text_color) {
                    $(".input-box .van-field__body").css({
                        //'border':`${vm.page.common_data.text_color} solid 1px`
                    })
                }
                // console.log(vm.$refs.is.style)
                // vm.$refs.is.style.setProperty('placeholderColor', vm.page.common_data.text_color);
            })
        },
		methods:{
            /**
